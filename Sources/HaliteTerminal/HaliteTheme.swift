...
public extension HaliteTheme {
    ...
    static var tokyoNightStorm: HaliteTheme {
        HaliteTheme(
    ...
    static var tokyoNightLight: HaliteTheme {
        HaliteTheme(
    ...
    static var monokai: HaliteTheme {
        HaliteTheme(
            name: "Monokai",
    ...
    static var oneDark: HaliteTheme {
        HaliteTheme(
            name: "One Dark",
    ...
    static var oneLight: HaliteTheme {
        HaliteTheme(
            name: "One Light",
    ...
    static var catppuccinMocha: HaliteTheme {
        HaliteTheme(
    ...
    static var catppuccinMacchiato: HaliteTheme {
        HaliteTheme(
    ...
    static var catppuccinFrappe: HaliteTheme {
        HaliteTheme(
    ...
    static var catppuccinLatte: HaliteTheme {
        HaliteTheme(
    ...
    static var nightOwl: HaliteTheme {
        HaliteTheme(
            name: "Night Owl",
    ...
    static var ayuDark: HaliteTheme {
        HaliteTheme(
            name: "Ayu Dark",
    ...
    static var ayuMirage: HaliteTheme {
        HaliteTheme(
            name: "Ayu Mirage",
    ...
    static var githubDark: HaliteTheme {
        HaliteTheme(
            name: "GitHub Dark",
    ...
    static var githubLight: HaliteTheme {
        HaliteTheme(
            name: "GitHub Light",
    ...
    static var rosePine: HaliteTheme {
        HaliteTheme(
            name: "Rosé Pine",
    ...
    static var rosePineMoon: HaliteTheme {
        HaliteTheme(
            name: "Rosé Pine Moon",
    ...
    static var rosePineDawn: HaliteTheme {
        HaliteTheme(
            name: "Rosé Pine Dawn",
    ...
    static var palenight: HaliteTheme {
        HaliteTheme(
            name: "Palenight",
    ...
    static var cobalt2: HaliteTheme {
        HaliteTheme(
            name: "Cobalt2",
    ...
    static var tomorrowNight: HaliteTheme {
        HaliteTheme(
            name: "Tomorrow Night",
    ...
    static var tomorrowNightEighties: HaliteTheme {
        HaliteTheme(
    ...
    static var tomorrow: HaliteTheme {
        HaliteTheme(
            name: "Tomorrow",
    ...
    static var hyperSnazzy: HaliteTheme {
        HaliteTheme(
            name: "Hyper Snazzy",
    ...
    static var material: HaliteTheme {
        HaliteTheme(
            name: "Material",
    ...
    static var everforestDark: HaliteTheme {
        HaliteTheme(
    ...
    static var kanagawa: HaliteTheme {
        HaliteTheme(
            name: "Kanagawa",
    ...
    static var iceberg: HaliteTheme {
        HaliteTheme(
            name: "Iceberg",
    ...
    static var gruvboxLight: HaliteTheme {
        HaliteTheme(
            name: "Gruvbox Light",
